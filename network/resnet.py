...
class ResNet18(nn.Module):
    def __init__(self, shape, num_classes, checkpoint_dir='checkpoint', chekcpoint_name='ResNet18',
        ...
        self.checkpoint_name = chekcpoint_name
        ...
        self.avgplool = nn.AdaptiveAvgPool2d((1, 1))
